<link rel="stylesheet" type="text/css" href="/public/css/ticketSupport.css">
	...
	<div id="main">
		...
		<div class = "Liste_ticket">
			...
			$i = 0;
			foreach ($Tickets as $Ticket) : ?>
			<div class="Tickets"><div class="expander"><?php echo $Ticket['email'] . ' '. $Ticket['time'] ?></div></div>
		...
		<div class="status-form">
			<form action="" method="post">
					...
					<select class="ticketChoice" name="ticketChoice">
					...
					<select class="Statuts" name="Statuts">
