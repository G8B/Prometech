...
<div id="user-compte">
        ...
        <p >
            Prenom :
            <input class="compte" type="text" name="newprenom" placeholder="<?php echo $userInfos['prenom']?>"   size="25"/>
        </p>
        <br>
    
        <p >
            Email :
            <input class="compte" type="mail" name="newmail"  placeholder="<?php echo $userInfos['email']?>"  size="25"/>
        </p>
        <br>
        <p >
            Mot de passe actuel :
