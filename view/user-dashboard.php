...
<div id="dashboard-nav">
    <a class="dashboard-nav-link active" href="../index.php?target=user&page=dashboard&spage=capteur_piece"><i
                class="fas fa-sliders-h"></i></a>
    <a class="dashboard-nav-link" href="../index.php?target=user&page=dashboard-conso&spage=graph_conso"><i
                            ...
                            <div class="product-box"
                                ...
                                if (getActionneurModele($product['numeroDeSerie']) != 'a') {
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <div id="btn-bg">
                                            <button type="submit" name="moteur"
                                                    value=<?php echo $product['numeroDeSerie'] ?>>
